...
public:
	...
	*/
	 ...
	 */
	virtual void OnClassStart(std::vector<PeerInfo> peerinfos) = 0;
...
private:
	...
	bool Join(std::string displayName, std::string device);

	bool JoinRoom(std::string displayName, std::string device);
